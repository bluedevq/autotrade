                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="input-group">
                            <div class="input-group-addon form-login"><i class="fas fa-shield-alt"></i></div>
                            <input type="text" name="td_code" class="form-control" id="td_code" placeholder="Mã xác nhận Email">
                        </div>
                    </div>
                    <div class="col-4">
            ...
            <div class="mt-4 aresbo-login-authentication">
                <div class="row">
                    ...
                    <div class="col-12 input-group">
                        <div class="input-group-addon form-login"><i class="fas fa-shield-alt"></i></div>
                        <input type="text" name="code" class="form-control" id="code" placeholder="Mã Google Authentication">
                    </div>
                </div>
            </div>
            <div class="mt-4">
                <div class="row">
                    <div class="col-12">
                        ...
                        <button class="btn btn-danger btn-block col-12" type="submit" onclick="showLoading()"><span class="fas fa-sign-in-alt">&nbsp;</span>Gửi</button>
                    </div>
                </div>
            </div>
        </form>
