<div class="mt-2">
    <div class="row">
        <div class="col-md-6 col-12">
            ...
            <div class="row">
                <div class="col-12 mt-2 mx-auto text-center setting-profit">
                    <div class="bg-secondary">
                        ...
                        <div class="col-4 take-profit-btn" onclick="BotController.stopLossOrTakeProfit()"><span class="setting-profit-text">Chốt lời</span><span class="percent take-profit-percent"></span></div>
